...
- [x] 프로젝트 동작원리 분석을 위한 학습 진행
  ...
  - [ ] (TODO) 프로젝트의 resources/static에 어떤 파일이 있고, 어떤 구조로 배치되어 있는지 분석하기
- [ ] (TODO) 로거의 사용법 학습
...
- [ ] (TODO) Thread로 구현된 웹서버를 Concurrent 패키지를 활용하여 리팩토링
  - 무한적으로 생성되는 Thread는 매우 비효율적이므로 Concurrent 패키지의 Thread Pool을 활용하여 리팩토링 예정
- [ ] (TODO) HTTP Request 내용을 파싱하고 로거로 출력하는 기능
- [ ] (TODO) localhost:8080/index.html 요청 시 index.html 파일을 읽어서 응답하는 기능 구현
  - [ ] (TODO) requestbody를 유연하게 조립하는 방법을 고민하기
- [ ] (TODO) OOP 원칙에 따라 클래스의 책임을 최대한 줄이고, 단위 테스트가 가능하도록 코드 구조 고민하기