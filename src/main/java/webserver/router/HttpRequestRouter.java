 ...
 */
public class HttpRequestRouter implements Router<HttpRequestHeader, HttpResponseHandler> {

    @Override
    public HttpResponseHandler route(HttpRequestHeader httpRequestHeader) {
